  ...
  render () {
    return (
      <header className= "mb-0">
        <Navbar className="navbar-expand-sm navbar-dark navbar-toggleable-sm ng-white border-bottom box-shadow mh-100 bg-dark" >
            ...
            <Collapse className="d-sm-inline-flex flex-sm-row-reverse bg-dark" isOpen={!this.state.collapsed} navbar>
                ...
                <NavItem className= "bg-dark">
                            ...
                            <NavItem className="bg-dark">
                                <NavLink tag={Link} className="text-light bg-dark " to="/get-listings">My Listing</NavLink>
                            </NavItem>
